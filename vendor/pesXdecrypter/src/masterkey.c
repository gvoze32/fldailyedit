...
CRYPTER_EXPORT const uint8_t MasterKeyZero[] = {
...
// PES 2019 regular edition MasterKey.
CRYPTER_EXPORT const uint8_t MasterKeyPes19[] = {
...
// PES 2020 regular edition MasterKey.
CRYPTER_EXPORT const uint8_t MasterKeyPes20[] = {
