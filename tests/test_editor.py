...
from editor.roster import (
    ...
    MAX_TEAM_PLAYER, MAX_GAME_PLANS,
...
class TestEditFileHeader:
    ...
    def test_repair_game_plan_preserves_known_primary_goalkeeper(self):
        data = _build_mock_data(
            num_players=40,
            num_teams=1,
            num_team_player=1,
        ...
        metrics = edit_file.repair_game_plans(preserve_existing_primary=True)
