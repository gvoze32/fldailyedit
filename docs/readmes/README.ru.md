...
В чистых сохранениях PES21 могут оставаться номера футболок в пустых слотах
состава. Они показываются как некритичные предупреждения и не блокируют локальное
обновление.
