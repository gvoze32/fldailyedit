...
1. **GUI 中的本地更新模式（替代分发多个预构建基础文件）** — 无需为每个补丁分发独立的预构建基础存档，而是在安装程序图形界面中直接增加本地更新功能，使用户可以在其自身的存档文件上运行转会流程（支持 **SP Football Life 2026**、**vanilla eFootball PES 2021** 和 **UML**）。
